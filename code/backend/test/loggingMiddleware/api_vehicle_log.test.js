...
test("TC20 View Vehicle", async () => {
  const expectedAction = "VEHICLE_VIEWED"
  const expectedAccessResult = "SUCCESS"
  const reqPath = "/api/vehicles"
  const method = "GET"
  const req = {
    user: { sub: 1 },
    method: method,
...
test("TC21 Add Vehicle", async () => {
  const expectedAction = "VEHICLE_CREATED"
  const expectedAccessResult = "SUCCESS"
  const reqPath = "/api/vehicles"
  const method = "POST"
  const req = {
...
test("TC22 Update Route", async () => {
  const expectedAction = "VEHICLE_UPDATED"
  const expectedAccessResult = "SUCCESS"
  const reqPath = "/api/vehicles"
  const method = "PATCH"
  const req = {
...
test("TC23 Delete Route", async () => {
  const expectedAction = "VEHICLE_DELETED"
  const expectedAccessResult = "SUCCESS"
  const reqPath = "/api/vehicles"
  const method = "DELETE"
  const req = {
