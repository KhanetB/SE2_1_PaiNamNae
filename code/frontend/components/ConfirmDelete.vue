  ...
  <div v-if="isVisible" class="modal-overlay" @click.self="closeModal">
    <div class="modal-content">
      ...
      <div v-if="step === 1">
        ...
        <div ref="chatContainer" class="my-4 h-64 overflow-y-auto rounded-xl border border-gray-300 bg-white p-6 shadow-sm scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
          <!-- Main Title -->
          <h2 class="text-2xl md:text-xl font-bold mb-4">
            ข้อกำหนดและเงื่อนไขการใช้สิทธิขอถอนตัว ลบข้อมูลส่วนบุคคล และขอรับสำเนาข้อมูล
          </h2>
          ...
          <p class="mb-8">
            เพื่อให้เป็นไปตามบทบัญญัติแห่งพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 
            ผู้ใช้บริการ (ซึ่งต่อไปนี้จะเรียกว่า 
            <span class="font-semibold">"เจ้าของข้อมูลส่วนบุคคล"</span>) 
            มีสิทธิในการขอเข้าถึง รับสำเนา และขอให้ระงับหรือลบทำลายข้อมูลส่วนบุคคลของตน 
          ...
          <p class="mb-6">
            ก่อนการดำเนินการลบบัญชีผู้ใช้ บริษัทฯ/เว็บไซต์ จะทำการประมวลผลเพื่อจัดส่งสำเนาข้อมูลส่วนบุคคล
          ...
          <ul class="list-disc pl-8 space-y-4 mb-8">
            <li>
              <span class="font-semibold">
                (1) ข้อมูลอัตลักษณ์และการพิสูจน์ยืนยันตัวตน (Identity & Verification Data):
              </span>
              ชื่อผู้ใช้ (Username), ที่อยู่อีเมล, ชื่อ-นามสกุล, เพศ, หมายเลขโทรศัพท์ติดต่อ, 
              ภาพถ่ายประจำตัว, ข้อมูลตามบัตรประจำตัวประชาชน, ภาพถ่ายใบหน้าเพื่อการตรวจสอบ (Selfie) 
              รวมถึงข้อมูลใบอนุญาตขับขี่ (ในกรณีผู้ใช้สถานะผู้ให้บริการขับขี่)
            </li>
            ...
            <li>
              ...
              รายละเอียดเชิงเทคนิคและลักษณะทางกายภาพของยานพาหนะ ได้แก่ รุ่น, ประเภท, สี, 
              หมายเลขทะเบียนรถ, จำนวนที่นั่ง และอุปกรณ์ส่วนควบหรือสิ่งอำนวยความสะดวก
            </li>

            <li>
              <span class="font-semibold">
                (3) ข้อมูลประวัติการทำธุรกรรมและการใช้งาน (Transaction & Activity History):
              </span>
              รายละเอียดการสร้างเส้นทาง, ประวัติการสำรองที่นั่ง, วันเวลาที่เกิดรายการ, 
              สถานะธุรกรรม รวมถึงบันทึกเหตุผลแห่งการปฏิเสธหรือยกเลิกรายการ (ถ้ามี)
            </li>
          </ul>
          ...
          <p class="mb-6">
            เมื่อผู้ใช้แสดงเจตนาลบบัญชีและยืนยันคำขอ ให้ถือว่าความตกลงนี้มีผลผูกพันดังนี้:
          </p>

          <ul class="list-disc pl-8 space-y-4 mb-8">
            <li><span class="font-semibold">การระงับสิทธิใช้งาน:</span> บัญชีผู้ใช้จะถูกระงับการเข้าถึง (Deactivated) และยุติการให้บริการในทันที</li>
            <li><span class="font-semibold">กระบวนการทำลายข้อมูล:</span> ข้อมูลส่วนบุคคลจะถูกดำเนินการทำให้ไม่สามารถระบุตัวบุคคลได้ (Anonymization) หรือลบทำลายตามมาตรฐานทางเทคนิค ภายในระยะเวลาไม่เกิน 90 (เก้าสิบ) วัน</li>
            <li><span class="font-semibold">ข้อยกเว้นการลบข้อมูล:</span> เว็บไซต์ขอสงวนสิทธิในการเก็บรักษาข้อมูลบางส่วนไว้เท่าที่จำเป็น เพื่อประโยชน์ในการพิสูจน์สิทธิ หรือปฏิบัติตามกฎหมายที่เกี่ยวข้อง</li>
            <li><span class="font-semibold">ผลสิ้นสุดถาวร:</span> การลบบัญชีเป็นการดำเนินการที่ไม่อาจกลับคืนสู่สภาพเดิมได้ (Irreversible)</li>
          </ul>
          ...
          <ol class="list-decimal pl-8 space-y-4">
            <li>ข้าพเจ้าเป็นเจ้าของบัญชีผู้ใช้และเป็นเจ้าของข้อมูลส่วนบุคคลที่แท้จริงตามกฎหมาย</li>
            <li>ข้าพเจ้าได้อ่านและเข้าใจในรายละเอียด ผลกระทบ และความเสี่ยงทางกฎหมายจากการลบบัญชีและข้อมูลส่วนบุคคลเป็นอย่างดีแล้ว</li>
            <li>ข้าพเจ้าให้ความยินยอมโดยชัดแจ้งให้เว็บไซต์ประมวลผลและจัดส่งข้อมูลไปยังที่อยู่อีเมลที่ระบุไว้</li>
          </ol>
        </div>
