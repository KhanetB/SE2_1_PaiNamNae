                ...
                <div class="flex items-center justify-between h-16">
                    <NuxtLink to="/">
                        <div class="flex items-center">
                            <h1
                                class="text-xl font-bold text-blue-600 sm:text-2xl"
                            >
                                ไปนำแหน่
                            </h1>
                        </div>
                    ...
                    <nav
                        class="items-center hidden space-x-6 md:flex lg:space-x-8"
                    >
                        <NuxtLink
                            to="/findTrip"
                            class="font-medium text-gray-600 transition-colors duration-200 hover:text-blue-700"
                            :class="{
                                'text-blue-600': $route.path === '/findTrip',
                            }"
                        >
                            ค้นหาเส้นทาง
                        </NuxtLink>
                        ...
                        <AppNotificationPanel v-if="token" />
                        ...
                        >
                            ...
                            >
                                ...
                                <svg
                                    ...
                                    :class="{
                                        'rotate-180': isMobileTripMenuOpen,
                                    }"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
...
onMounted(() => window.addEventListener("resize", handleNavResize));
onUnmounted(() => window.removeEventListener("resize", handleNavResize));
