                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            >
                                                <li
                                                    v-for="detail in route.carDetails"
                                                    :key="detail"
                                                >
                                                    • {{ detail }}
                                                </li>
                                        ...
                                        >
                                            ...
                                            <span
                                                v-if="
                                                    ...
                                                    'in_transit'
                                                "
                                                class="status-badge status-transit"
                                                >กำลังเดินทางมารับคุณ</span
                                            >
                                            <span
                                                v-else-if="
                                ...
                                <div class="flex items-center mb-4 space-x-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center mt-1">
                                            <div
                                                class="flex text-sm text-yellow-400"
                                            >
                                                <span>
                                                    {{
                                                        "★".repeat(
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            >
                                                <li
                                                    v-for="detail in trip.carDetails"
                                                    :key="detail"
                                                >
                                                    • {{ detail }}
                                                </li>
...
const confirmDropoff = async (tripId) => {
    try {
        const res = await $fetch(`/bookings/${tripId}/driver-confirm-dropoff`, {
            method: "PATCH",
        ...
        console.error("Error complete routue: ", error.response);
        ...
        for (const r of routes) {
            ...
            for (const b of r.bookings || []) {
                formatted.push({
                    ...
                    originAddress: start?.address
                        ? cleanAddr(start.address)
                        : null,
                    destinationAddress: end?.address
                        ? cleanAddr(end.address)
                        : null,
                    durationText:
...
const completedRoute = async (routeId) => {
    try {
        const res = await $fetch(`/routes/${routeId}/complete`, {
            method: "PATCH",
            baseURL: config.public.apiBase,
            headers: {
                Accept: "application/json",
        ...
        console.error("Error complete routue: ", error.response);
        toast.error("เกิดข้อผิดพลาด", `${error.response._data.message}`);
    }
};
