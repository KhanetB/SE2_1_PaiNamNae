*** Settings ***
Documentation   US-4: ผู้ใช้สามารถส่งรีวิว 3 ดาว พร้อม Labels ไม่มีข้อความ มีรูปภาพ
...
TC12 ให้คะแนน 3 ดาว เลือก Label ไม่กรอกข้อความ มีรูปภาพ
    [Documentation]    ส่งรีวิว 3 ดาว พร้อม labels โดยไม่มีข้อความ แต่มีรูปภาพ ควรสำเร็จ
    # ให้คะแนน 3 ดาว
    Set Rating    3
    ...
    # ไม่กรอกข้อความ เพียงแนบรูปภาพ
    # ใช้ keyword Add Review Text And Image โดยส่ง empty string สำหรับ review text
    Add Review Text And Image    ${EMPTY}    ${IMAGE}
