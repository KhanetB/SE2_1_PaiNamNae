*** Settings ***
Documentation   US-5: ผู้ใช้สามารถส่งรีวิว 3 ดาว พร้อม Labels มีข้อความ ไม่มีรูปภาพ
...
TC15 ให้คะแนน 3 ดาว เลือก Label กรอกข้อความ ไม่มีรูปภาพ
    [Documentation]    ส่งรีวิว 3 ดาว พร้อม labels และข้อความ โดยไม่มีรูปภาพ ควรสำเร็จ
    # ให้คะแนน 3 ดาว
    Set Rating    3
