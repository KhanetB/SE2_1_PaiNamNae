*** Settings ***
Documentation   US2- การลบ Account แบบติดพันธะ
...
TC04, TC05 Login ผู้ใช้
    [Documentation]    ทดสอบล็อกอินด้วยบัญชีที่สร้างไว้ใน TC01
    Login To System    ${TEST_USER}    ${TEST_PASS}

TC06 ผู้ใช้ลบบัญชีตัวเอง
    [Documentation]    ทดสอบการลบบัญชีผู้ใช้ผ่านหน้าเว็บ
    Deletes Account Driver   ${TEST_EMAIL}    ${TEST_PASS}
    Wait Until Page Contains         คุณยังมีเส้นทางที่เป็นคนขับซึ่งยังไม่สิ้นสุด   timeout=10s
